...
namespace MVCManukauTech.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(PR03_P01_TeamContext context)
        {
            _context = context;    
        }
        ...
        {
            var pR03_P01_TeamContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
        ...
        public async Task<IActionResult> Create([Bind("UserId,RoleId,SilverMembership,GoldMembership,NoMembership")] AspNetUserRoles aspNetUserRoles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,RoleId,SilverMembership,GoldMembership,NoMembership")] AspNetUserRoles aspNetUserRoles)
        {
